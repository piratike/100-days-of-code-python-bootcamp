...
url_to_img = './Day 25 - Intermediate - CSV and Pandas/Project/blank_states_img.gif'
url_to_df = './Day 25 - Intermediate - CSV and Pandas/Project/50_states.csv'
url_to_learn = './Day 25 - Intermediate - CSV and Pandas/Project/states_to_learn.csv'
