...
class CafeForm(FlaskForm):
    ...
    opening_time = StringField('Opening timne', validators=[DataRequired()])
    closing_time = StringField('closing timne', validators=[DataRequired()])
    coffee_rating = SelectField('Coffee Rating', choices=['☕', '☕☕', '☕☕☕', '☕☕☕☕', '☕☕☕☕☕'])
    wifi_strength = SelectField('Wi-Fi Strength Rating', choices=['💪', '💪💪', '💪💪💪', '💪💪💪💪', '💪💪💪💪💪'])
